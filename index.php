...
<body>
    ...
    <div class="tarjetas">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="https://thegameawards.com/" class="btn btn-primary">Game Awards </a>
            </div>
        </div>
        <div class="card">
            <div class="ratio ratio-16x9">
            ...
            <div class="card-body">
                ...
                <a href="tienda/tienda.php" class="btn btn-primary">Ir a la tienda</a>
            </div>
        </div>
        <div class="card">
            <div class="ratio ratio-16x9">
    ...
    <div class="info row justify-content-between">
        <div class="infoCom col-6">
            <div class="presentacion">
                <h1>Lobo Gamer</h1>
                <p>¡Bienvenido a nuestra página de videojuegos! Aquí encontrará las últimas noticias y reseñas sobre los videojuegos más populares. Ya sea que sea fanático de los títulos clásicos o de los lanzamientos más recientes, lo tenemos cubierto. Entonces, ¡prepárate para explorar el mundo de los juegos y diviértete!
                </p>
            </div>
        </div>
        <div class="mapas col-5">
            <iframe class="mapa1" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3024.658953017922!2d-102.28946408623398!3d21.882853803055028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8429ee6ff81b0023%3A0xae813d61fb307634!2sAv.%20Francisco%20I.%20Madero%20446%2C%20Zona%20Centro%2C%2020000%20Aguascalientes%2C%20Ags.!5e0!3m2!1ses-419!2smx!4v1670622509619!5m2!1ses-419!2smx" width="700" height="700" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
